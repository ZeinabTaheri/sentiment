...
# آدرس فایل جملات
sentence_data = 'drive/My Drive/freelancer/habib/data/fa_2.xlsx'
...
def make_numberized_samples():
  ...
  pickle_address = 'drive/My Drive/freelancer/habib/data/data_11.pkl'
...
pickle_address = 'drive/My Drive/freelancer/habib/data/data_1.pkl'
...
model.save('drive/My Drive/freelancer/habib/1.h5')

# لود کردن مدل
from tensorflow.keras.models import load_model
model = load_model('drive/My Drive/freelancer/habib/1.h5')
...
word_data = 'drive/My Drive/freelancer/habib/data/Phrases.xlsx'
...
def make_numberized_samples():
  ...
  pickle_address = 'drive/My Drive/freelancer/habib/data/data_2.pkl'
  with open(pickle_address, 'wb') as f:
    pkl.dump(pickle_data, f)
...
# ذخیره مدل
model.save('drive/My Drive/freelancer/habib/2.h5')

# لود کردن مدل
from tensorflow.keras.models import load_model
model = load_model('drive/My Drive/freelancer/habib/2.h5')
